...
pub fn encrypt(_: *ChaCha20, reader: *std.Io.Reader, writer: *std.Io.Writer, key: []const u8) !void {
...
pub fn decrypt(_: *ChaCha20, reader: *std.Io.Reader, writer: *std.Io.Writer, key: []const u8) !void {
    // 1. Read Base Nonce
    var base_nonce: [NONCE_SIZE]u8 = undefined;
